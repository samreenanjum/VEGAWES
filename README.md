...
* GC Content Data (Included in the package under /data as "GCContent.\<chromosome\>.RData". Please note that this data is generated for the provided exome list. For new exome lists, GC content will have to be regenerated. )
