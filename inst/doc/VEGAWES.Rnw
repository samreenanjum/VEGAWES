...
\begin{itemize}
  ...
  \item File containing list of exons to run GATK (The file \lq targets.interval\_list\rq~ is included in the package in the format: chr:probe\_start-probe\_end)
...
Example of "parameters.txt":\\
  ...
  /home/samreen/VEGAWES/inst/extdata/targets.interval\_list\\
  06-0125\\
